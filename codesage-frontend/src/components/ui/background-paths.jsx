...
function FloatingPaths({ position }) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-0">
      <svg
        className="w-full h-full text-zinc-800/20"
        viewBox="0 0 696 316"
        fill="none"
      >
                ...
                >
                  {word.split("").map((letter, letterIndex) => (
                    <motion.span
                      ...
                      className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-zinc-200 to-zinc-400"
                    >
                      {letter}
                    </motion.span>
                  ))}
